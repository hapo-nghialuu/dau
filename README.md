...
**Dấu** (`dau`) là bộ gõ tiếng Việt mã nguồn mở, offline 100%, dùng **Rust core** với bridge Fcitx5 trên Linux và native event tap trên macOS. Phiên bản **0.1.2**.
